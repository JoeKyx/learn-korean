        ...
        >
          {filteredCategories.map((category) => (
            <AccordionItem
              value={category.name}
              key={category.id}
              className='relative z-10 flex flex-col md:p-5 p-4'
            >
              ...
              <AccordionContent className='relative'>
                ...
                <div
                  className='absolute inset-0 z-0 rounded-lg border border-primary-500'
                  style={{
                ...
                {category.lessons.map((lesson) => (
                  ...
                  >
                    ...
                    <div className='flex w-1/2 justify-between'>
                      <LessonProgress
                        practiceWords={practiceLessonsWithLatestAttempt.lesson.words.filter(
