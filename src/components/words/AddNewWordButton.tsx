...
const AddNewWordButton: FC<AddNewWordButtonProps> = forwardRef<HTMLButtonElement, AddNewWordButtonProps>((props, ref) => {
    ...
    <Dialog>
      <DialogTrigger asChild={!customTrigger}>
        {customTrigger ? (
          ...
          <Button leftIcon={word ? Edit : Plus} className={className} ref={ref} {...rest}>
      ...
      <DialogContent>
        ...
        <div className="px-5 pb-5">
          <AddNewWordForm closeModal={closeModal} lessonId={lessonId} word={word} />
        </div>
      </DialogContent>
    </Dialog>
  );
