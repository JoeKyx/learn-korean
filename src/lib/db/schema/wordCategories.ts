...
export const insertWordCategorieParams = createSelectSchema(
  wordCategories,
  {}
).omit({
  id: true,
...
export const wordCategorieIdSchema = updateWordCategorieSchema.pick({
  id: true,
});
...
export type UpdateWordCategorieParams = z.infer<
  typeof updateWordCategorieParams
>;
...
export type CompleteWordCategorie = Awaited<
  ReturnType<typeof getWordCategories>
