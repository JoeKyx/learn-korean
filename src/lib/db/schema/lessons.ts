...
>['lessons'][number];
export type LessonWithCategory = Awaited<
  ReturnType<typeof getLessonsWithCategory>
>['categories'];
export type PracticeLesson = Awaited<
  ReturnType<typeof getPracticeLessons>
>['lesson'];
export type DatesStudied = Awaited<
  ReturnType<typeof getDatesStudiedByLanguage>
>['datesStudied'];
