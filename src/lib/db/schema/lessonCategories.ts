...
export const insertLessonCategorieParams = createSelectSchema(
  lessonCategories,
  {}
).omit({
  id: true,
...
export const updateLessonCategorieParams = createSelectSchema(
  lessonCategories,
  {}
);

export const lessonCategorieIdSchema = updateLessonCategorieSchema.pick({
  id: true,
});
...
export type NewLessonCategorieParams = z.infer<
  typeof insertLessonCategorieParams
>;
export type UpdateLessonCategorieParams = z.infer<
  typeof updateLessonCategorieParams
>;
...
export type CompleteLessonCategorie = Awaited<
  ReturnType<typeof getLessonCategories>
>['lessonCategories'][number];
